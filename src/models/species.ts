export interface Species {
  ...
  eye_colors: string;        // A comma-separated string of common eye colors for this species, "none"
                             // if this species does not typically have eyes.
  hair_colors: string;       // A comma-separated string of common hair colors for this species, "none"
                             // if this species does not typically have hair.
  skin_colors: string;       // A comma-separated string of common skin colors for this species, "none"
